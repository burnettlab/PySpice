...
ax1.grid()
ax1.set_xlim(-2, 2)
ax1.axvspan(-2, 0, facecolor="green", alpha=0.2)
ax1.axvspan(0, silicon_forward_voltage_threshold, facecolor="blue", alpha=0.1)
ax1.axvspan(silicon_forward_voltage_threshold, 2, facecolor="blue", alpha=0.2)
...
ax1.legend(
    ["@ {} °C".format(temperature) for temperature in temperatures]
...
ax2.grid()
ax2.set_xlim(-2, 3)
ax2.axvspan(-2, 0, facecolor="green", alpha=0.2)
ax2.axvspan(0, silicon_forward_voltage_threshold, facecolor="blue", alpha=0.1)
ax2.axvspan(silicon_forward_voltage_threshold, 3, facecolor="blue", alpha=0.2)
...
ax2.legend(["{} Resistance".format(x) for x in ("Static", "Dynamic")], loc=(0.05, 0.2))
